...
def card_main(
    ...
    # STATS PERIOD
    stats: Optional[str] = typer.Option(None, "--stats", "-st", help="Optionally pass stats as a JSON string. This will override any stats pulled from the MLB API or other datasource."),
