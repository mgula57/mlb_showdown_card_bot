...
/**
 * Season simulation results, grouped by season and ranked by wins (or, in "Best GM" mode, by
 * wins per roster point spent) — one row per team, its best run at that season.
 *
